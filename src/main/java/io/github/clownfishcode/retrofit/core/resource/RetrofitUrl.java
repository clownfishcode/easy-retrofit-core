...
import io.github.clownfishcode.retrofit.core.EnvManager;
import io.github.clownfishcode.retrofit.core.util.RetrofitUrlUtils;
import io.github.clownfishcode.retrofit.core.util.UniqueKeyUtils;
...
public final class RetrofitUrl implements UniqueKey {
    ...
    public RetrofitUrl(String baseUrl, String inputDynamicBaseUrl, String retrofitUrlPrefix, EnvManager env) {
